...
//	----Consultar camada de negócios - Classe Funcionário
	...
	private void initialize() {
		...
		btnRelContatos.setToolTipText("Gerar relatório com os parâmetros selecionados");
		
		//--Itens do cadastro completo
		JLabel lblRazaoCliente = new JLabel("Razão social");
		txtRazaoCliente = new JFormattedTextField(setMascara("*********************************************"));
		JLabel lblIeCliente = new JLabel("Inscrição estadual");
